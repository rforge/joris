...
public class SearchDataNode {
	...
	Name(NameType.class), String(StringCompareType.class), Number(Relation.class), Boolean(BoolCompareType.class);
     ...
     */
    public SearchDataNode removeChild(final SearchDataNode child) {
	children.remove(child);
	child.parent = null;
	return this;
    }

    public SearchDataNode getParent() {
	return parent;
    }
