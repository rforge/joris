...
@Transactional
public class SpringWiringTest implements ApplicationContextAware{
	...
	public void testSpringConfigDomainModel() {
		/*final XmlBeanFactory factory = new XmlBeanFactory(new ClassPathResource("spring-test.xml"));
		PropertyPlaceholderConfigurer cfg = new PropertyPlaceholderConfigurer();
		cfg.setLocation(new ClassPathResource("spring/jdbc.properties"));
	...
	public void testStoreDomainGraph() {
		...
		final Edge edge = new Edge(root, valueNode, domainGraph);
		DebugUtil.debugSchema(dataSource);
		//store
		final Session session = sessionFactory.openSession();
		final Transaction tx = (Transaction) session.beginTransaction();	
		tx.begin();
...
//		final ClassPathResource springResource = new ClassPathResource("spring-test.xml");
