package org.rosuda.graph.dao.inttest;
...
public class CRUDIntegrationTest {
    ...
    @Test
    public void testStoreSimpleGraph() throws SystemException, SecurityException, IllegalStateException, RollbackException, HeuristicMixedException,
	...
	// jdbcTemplate.queryForInt("SELECT COUNT(*) FROM VERTEX"));
	// Assert.assertEquals(0,
	// jdbcTemplate.queryForInt("SELECT COUNT(*) FROM GRAPH"));
	// Assert.assertEquals(0,
	// jdbcTemplate.queryForInt("SELECT COUNT(*) FROM EDGE"));
    }
