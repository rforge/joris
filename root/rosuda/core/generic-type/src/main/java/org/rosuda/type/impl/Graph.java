...
public class Graph<T> implements NodeBuilderFactory<T>, Serializable {
	...
	public String toString() {
	    return new StringBuilder(this.getClass().getSimpleName()).append("[name=").append(name).append(", value=").append(value).append("]").toString();
	}
    }
	...
	public void createReference(Builder<T> anotherNode) {
		...
		throw new UnsupportedOperationException("wrong argument type : " + anotherNode.getClass() + ", expected:" + BuilderFacade.class);
	...
	public void delete(Builder<T> child) {
		...
		throw new UnsupportedOperationException("wrong argument type : " + child.getClass() + ", expected:" + BuilderFacade.class);
	...
	public String toString() {
	    ...
	    builder.append("Node.Builder(internalNodeIdx=").append(nodeIdx);
	    if (nodes.containsKey(nodeIdx)) {
		builder.append(", name=").append(nodes.get(nodeIdx).getName());
	    }
	    builder.append(")");
	...
	public Iterable<Node<T>> getChildren() {
		...
		public Iterator<Node<T>> iterator() {
			...
			public boolean hasNext() {
			    /*
			     * if (childIdxList == null) return false;
			     */
			    return (i < childIdxList.size());
			}
	...
	public String toString() {
	    final StringBuilder builder = new StringBuilder();
	    builder.append("Node(name=").append(nodes.get(nodeIdx).getName()).append(")");
	    return builder.toString();
	}
