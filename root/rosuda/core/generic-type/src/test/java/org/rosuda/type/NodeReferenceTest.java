...
public class NodeReferenceTest extends TestCase{
	...
	//normally the BuilderFactory should be parametrized with a special node type 
	...
	public void testCreateLoopByReference() {
		...
		try {
			final Node<Graph<Object>> rootNode = rootBuilder.build();
			assertNotNull(rootNode);
			//System.out.println("rootWithRef:"+rootNode);
	...
	public void testStructure() {
		...
		//System.out.println(rootBuilder.build());
