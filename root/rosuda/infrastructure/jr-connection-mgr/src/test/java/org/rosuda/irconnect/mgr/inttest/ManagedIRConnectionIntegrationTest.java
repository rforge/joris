...
public class ManagedIRConnectionIntegrationTest {
	...
	Log LOG = LogFactory.getLog(ManagedIRConnectionIntegrationTest.class);
	...
	public void testIsTimpConnection() throws IOException {
		...
		final BufferedReader reader = new BufferedReader(new InputStreamReader(ManagedIRConnectionIntegrationTest.class.getResourceAsStream("/TIMPExample.R")));
		String line = null;
