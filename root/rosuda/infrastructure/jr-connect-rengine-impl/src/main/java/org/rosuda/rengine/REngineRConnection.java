...
public class REngineRConnection extends ARConnection implements IRConnection {
	...
	try {
	    ...
	    throw new RServerException(this, rse.getRequestErrorDescription(), MessageFormat.format("new RConnection(host={0},port={1}) failed with {2} ",host, port,rse.getMessage()));
	}
