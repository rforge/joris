...
public abstract class ProcessFactory<T> {
    ...
    static final Class<?>[] serviceInterfaces = new Class<?>[] { ProcessStarter.class, ProcessStopper.class, HasRunState.class,
    ...
    public ProcessService<T> createService() {
        return (ProcessService<T>) Proxy.newProxyInstance(this.getClass().getClassLoader(), serviceInterfaces, new ProcessProxy());
    }
    ...
    class ProcessProxy implements InvocationHandler {
        ...
        protected ProcessProxy() {
            this.delegates = new Object[] { ProcessFactory.this.createStarter(), ProcessFactory.this.createStopper(),
        ...
        public Object invoke(final Object proxy, final Method method, final Object[] args) throws Throwable {
            ...
            throw new UnsupportedOperationException("cannot execute method " + method);
        }
    }
}
